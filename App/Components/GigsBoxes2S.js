...
function GigsBoxes2S({text,text2,text3,image,style,onPress,navigation, width}) {
    return (
        ...
        <View style={styles.gigsbox}>
         ...
         <View style={styles.gigsbox2}>
             ...
             <ImageBackground imageStyle={{borderRadius:10}} style={styles.gigpic} source={require('../assets/yellow.png')}>
             <ShareIcon></ShareIcon>
             </ImageBackground>
             <LinearGradient
                  colors={['transparent','black']}
