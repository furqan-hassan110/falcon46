...
function PrivacynPolicy({navigation}) {
    return (<>
        <View style={styles.header}>
            <Icon name='arrow-left' style={styles.headerIcon} onPress={() => navigation.goBack()}/>
            <Text style={styles.HText}>Privacy and policy</Text>
        </View>
        <ScrollView>
        <Image style={{width:145,alignSelf:'center', height:55, marginTop:20}} source={require('../App/assets/gigfalcon.png')}></Image>
        <SearchBox></SearchBox>
        <Divider style={{marginTop:20}} orientation="vertical" width={5} />
        <Text style={styles.Text3}>Gig Falcon's Privacy and policy</Text>
